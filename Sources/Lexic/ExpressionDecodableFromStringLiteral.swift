...
protocol ExpressionDecodableFromStringLiteral: ExpressionDecodable<StringLiteralExprSyntax> {
    init?(_ string: String)
}
extension ExpressionDecodableFromStringLiteral {
    init(from node: borrowing StringLiteralExprSyntax) throws(ExpressionDecodingError) {
        guard
